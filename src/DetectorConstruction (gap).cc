...
if (fDetectorGeometry == 1 || fDetectorGeometry == 3){  
  ...
  //bottom 3
  P.setX(-fTotalDetectorDiameter - fAirGap); P.setY((-0.875*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter - fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX(0.); P.setY((-0.875*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter - fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //4
  P.setX(-1.5*fTotalDetectorDiameter - 1.5*fAirGap); P.setY((-0.375*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX(-0.5*fTotalDetectorDiameter - 0.5*fAirGap); P.setY((-0.375*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //3
  P.setX(-fTotalDetectorDiameter - fAirGap); P.setY((0.125*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter + fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX(0.); P.setY((0.125*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter + fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  //top 4
  P.setX((0.5 + 0.5*sqrt(3))*fTotalDetectorDiameter + (0.5 + 0.5*sqrt(3))*fAirGap); P.setY((0.625*sqrt(3) + 0.5 + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter + 2.5*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX(0.5*fTotalDetectorDiameter + 0.5*fAirGap); P.setY((0.625*sqrt(3) + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter + 2*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //below the top 4
  P.setX((1 + 0.5*sqrt(3))*fTotalDetectorDiameter + (1 + 0.5*sqrt(3))*fAirGap); P.setY((0.125*sqrt(3) + 0.5 + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter + 1.5*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //4
  P.setX((1.5 + 0.5*sqrt(3))*fTotalDetectorDiameter + (1.5 + 0.5*sqrt(3))*fAirGap); P.setY((-0.375*sqrt(3) - 0.5 + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter - 0.5*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX((1 + 0.5*sqrt(3))*fTotalDetectorDiameter + (1 + 0.5*sqrt(3))*fAirGap); P.setY((-0.875*sqrt(3) - 0.5 + 0.125*sqrt(3) - 1/(4*sqrt(3)))*fTotalDetectorDiameter - 1.5*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
...
//  No Rotation Now
  ...
  //10 detectors with 10 straddling detectors
  //leftmost 3
  P.setX((-0.5*sqrt(3) - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter - fAirGap); P.setY(-fTotalDetectorDiameter - fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX((-0.5*sqrt(3) - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter - fAirGap); P.setY(0.); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //4
  P.setX((-0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter); P.setY(-1.5*fTotalDetectorDiameter - 1.5*fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX((-0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter); P.setY(-0.5*fTotalDetectorDiameter - 0.5*fAirGap); P.setZ(0.5*fTotalDetectorLength + 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  //10 straddling detectors
  //rightmost 4
  P.setX((0.5 + sqrt(3) - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter + 2.5*fAirGap); P.setY(-1.5*fTotalDetectorDiameter - (0.5 + 0.5*sqrt(3))*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  
  P.setX((sqrt(3) - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter + 2*fAirGap); P.setY(-0.5*fTotalDetectorDiameter - 0.5*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  P.setX((0.5 + 0.5*sqrt(3) - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter + 1.5*fAirGap); P.setY(2*fTotalDetectorDiameter + (1 + 0.5*sqrt(3))*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  ...
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
  //4
  P.setX((-0.5 - 0.5*sqrt(3) + 1/(2*sqrt(3)))*fTotalDetectorDiameter - 0.5*fAirGap); P.setY(2.5*fTotalDetectorDiameter + (1.5 + 0.5*sqrt(3))*fAirGap); P.setZ(0.5*fTotalDetectorLength - 2.54*cm);
  Tr = G4Transform3D(rotm180,P);
  assemblyDetector->AddPlacedVolume(fLogicDetector,Tr);
