...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  // Energy resolution at room temperature: BGO - 10.3%, LaBr3:Ce - 3.2%
  // So the LaBr3:Ce detector energy resolution is the BGO energy resolution divided by 10.3/3.2 = 3.21875
  ...
  if (volume == fDetector->GetScint()){
    ...
    G4double fERes = fEOrig + fEOrig * fRandomGauss->fire(0.0, (76.3*3.21875/235.5)/std::sqrt(fEOrig*1000));
