...
fSolidPMTWin(0),fLogicPMTWin(0),fPhysiPMTWin(0)
{
  ...
  fDetectorLength = (7.62*fPMTDiameter)/5.9;
  fDetectorDiameter = (5.58*fPMTDiameter)/5.9;
  ...
  fAlCaseLength1 = (5.75*fAlCaseDiameter1)/5.18;
  fPMTDiameter1 = (5.1*fAlCaseDiameter1)/5.18;
  fPMTLength1 = (6.2*fAlCaseDiameter1)/5.18;
  fPMTWinThickness1 = (0.2*fAlCaseDiameter1)/5.18;
  fDetectorLength1 = (5.08*fAlCaseDiameter1)/5.18;
  fDetectorDiameter1 = (5.08*fAlCaseDiameter1)/5.18;
...
if (fDetectorGeometry == 2 || fDetectorGeometry == 4){
  ...
  //P.setX(-2*fTotalDetectorDiameter1 - 2*fAirGap); P.setY(3.175*cm + 0.5*fTotalDetectorDiameter1); P.setZ(-fZpos1);
  ...
  //P.setX(-fTotalDetectorDiameter1 - fAirGap); P.setY(3.175*cm + 0.5*fTotalDetectorDiameter1); P.setZ(-fZpos1);
  ...
  //P.setX(0*cm); P.setY(3.175*cm + 0.5*fTotalDetectorDiameter1); P.setZ(-fZpos1);
