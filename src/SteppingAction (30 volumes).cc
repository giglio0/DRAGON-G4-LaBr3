...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  if (volume == fDetector->GetScint2()){
    ...
    G4double fERes2 = fEOrig2 + fEOrig2 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig2*1000000));
  ...
  if (volume == fDetector->GetScint3()){
	...
	G4double fERes3 = fEOrig3 + fEOrig3 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig3*1000000));
  ...
  if (volume == fDetector->GetScint4()){
	...
	G4double fERes4 = fEOrig4 + fEOrig4 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig4*1000000));
  ...
  if (volume == fDetector->GetScint5()){
	...
	G4double fERes5 = fEOrig5 + fEOrig5 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig5*1000000));
  ...
  if (volume == fDetector->GetScint6()){
	...
	G4double fERes6 = fEOrig6 + fEOrig6 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig6*1000000));
  ...
  if (volume == fDetector->GetScint7()){
	...
	G4double fERes7 = fEOrig7 + fEOrig7 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig7*1000000));
  ...
  if (volume == fDetector->GetScint8()){
	...
	G4double fERes8 = fEOrig8 + fEOrig8 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig8*1000000));
  ...
  if (volume == fDetector->GetScint9()){
	...
	G4double fERes9 = fEOrig9 + fEOrig9 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig9*1000000));
  ...
  if (volume == fDetector->GetScint10()){
	...
	G4double fERes10 = fEOrig10 + fEOrig10 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig10*1000000));
  ...
  if (volume == fDetector->GetScint11()){
	...
	G4double fERes11 = fEOrig11 + fEOrig11 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig11*1000000));
  ...
  if (volume == fDetector->GetScint12()){
	...
	G4double fERes12 = fEOrig12 + fEOrig12 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig12*1000000));
  ...
  if (volume == fDetector->GetScint13()){
	...
	G4double fERes13 = fEOrig13 + fEOrig13 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig13*1000000));
  ...
  if (volume == fDetector->GetScint14()){
	...
	G4double fERes14 = fEOrig14 + fEOrig14 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig14*1000000));
  ...
  if (volume == fDetector->GetScint15()){
	...
	G4double fERes15 = fEOrig15 + fEOrig15 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig15*1000000));
  ...
  if (volume == fDetector->GetScint16()){
	...
	G4double fERes16 = fEOrig16 + fEOrig16 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig16*1000000));
  ...
  if (volume == fDetector->GetScint17()){
	...
	G4double fERes17 = fEOrig17 + fEOrig17 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig17*1000000));
  ...
  if (volume == fDetector->GetScint18()){
	...
	G4double fERes18 = fEOrig18 + fEOrig18 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig18*1000000));
  ...
  if (volume == fDetector->GetScint19()){
	...
	G4double fERes19 = fEOrig19 + fEOrig19 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig19*1000000));
  ...
  if (volume == fDetector->GetScint20()){
	...
	G4double fERes20 = fEOrig20 + fEOrig20 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig20*1000000));
  ...
  if (volume == fDetector->GetScint21()){
	...
	G4double fERes21 = fEOrig21 + fEOrig21 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig21*1000000));
  ...
  if (volume == fDetector->GetScint22()){
	...
	G4double fERes22 = fEOrig22 + fEOrig22 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig22*1000000));
  ...
  if (volume == fDetector->GetScint23()){
	...
	G4double fERes23 = fEOrig23 + fEOrig23 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig23*1000000));
  ...
  if (volume == fDetector->GetScint24()){
	...
	G4double fERes24 = fEOrig24 + fEOrig24 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig24*1000000));
  ...
  if (volume == fDetector->GetScint25()){
	...
	G4double fERes25 = fEOrig25 + fEOrig25 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig25*1000000));
  ...
  if (volume == fDetector->GetScint26()){
	...
	G4double fERes26 = fEOrig26 + fEOrig26 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig26*1000000));
  ...
  if (volume == fDetector->GetScint27()){
	...
	G4double fERes27 = fEOrig27 + fEOrig27 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig27*1000000));
  ...
  if (volume == fDetector->GetScint28()){
	...
	G4double fERes28 = fEOrig28 + fEOrig28 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig28*1000000));
  ...
  if (volume == fDetector->GetScint29()){
	...
	G4double fERes29 = fEOrig29 + fEOrig29 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig29*1000000));
  ...
  if (volume == fDetector->GetScint30()){
	...
	G4double fERes30 = fEOrig30 + fEOrig30 * fRandomGauss->fire(0.0, 9.72/std::sqrt(fEOrig30*1000000));
